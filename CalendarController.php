...
class CalendarController {
    ...
    public function createForm3($request, $response, $args){
        $ms = $this->ci->alerts;
		$currentUser = $this->ci->currentUser;
		$calendar3 = Calendar3::where('user_id', $currentUser->id)->first();
		if ($calendar3 != NULL) {
        ...
        $this->ci->view->render($response, "FormGeneratorJY/CalxUpdate.html.twig", [
            ...
            "box_title" => "Join Game Session",
            "submit_button" => "Join",
            "form_action" => "/calendar/3",
            "fields" => $form->generate(),
            "validators" => $validator->rules('json', true)
        ]);        
    }

    public function create3($request, $response, $args){
        $ms = $this->ci->alerts;
        $post = $request->getParsedBody();
        $schema = new RequestSchema("schema://forms/calendar.json");
        $transformer = new RequestDataTransformer($schema);
        ...
        $calendar3 = new Calendar3($data);
        $calendar3->user_id = $currentUser->id;
		$calendar3->save();
    ...
    public function editForm3($request, $response, $args){
        $ms = $this->ci->alerts;
        $get = $request->getQueryParams();
		$currentUser = $this->ci->currentUser;       
        $calendar3 = Calendar3::where('user_id', $currentUser->id)->first();
		$calendar3_id = $args['calendar3_id'];
        $schema = new RequestSchema("schema://forms/calendar.json");
        $validator = new JqueryValidationAdapter($schema, $this->ci->translator);
      
        $form = new Form($schema, $calendar3);

        $this->ci->view->render($response, "FormGeneratorJY/CalxUpdate.html.twig", [
            "box_id" => $get['box_id'],
            "box_title" => "Change",
            "submit_button" => "Change",
            "form_action" => "/calendar/3/".$args['calendar3_id'],
            "form_method" => "PUT", //Send form using PUT instead of "POST"
            "fields" => $form->generate(),
            "validators" => $validator->rules('json', true)
        ]);       
    ...
    public function update3($request, $response, $args){
        $ms = $this->ci->alerts;
		$currentUser = $this->ci->currentUser;
        $calendar3_id = $args['calendar3_id'];
        $calendar3 = Calendar3::where('user_id', $currentUser->id)->first();
    ...
    public function delete3($request, $response, $args){
        $ms = $this->ci->alerts;
		$currentUser = $this->ci->currentUser;
        $calendar3_id = $args['calendar3_id'];
        $calendar3 = Calendar3::where('user_id', $currentUser->id)->first();
    ...
    public function createForm4($request, $response, $args){
        $ms = $this->ci->alerts;
		$currentUser = $this->ci->currentUser;
		$calendar4 = Calendar4::where('user_id', $currentUser->id)->first();
		if ($calendar4 != NULL) {
        ...
        $this->ci->view->render($response, "FormGeneratorJY/CalxUpdate.html.twig", [
            ...
            "box_title" => "Join Game Session",
            "submit_button" => "Join",
            "form_action" => "/calendar/4",
            "fields" => $form->generate(),
            "validators" => $validator->rules('json', true)
        ]);        
    }

    public function create4($request, $response, $args){
        $ms = $this->ci->alerts;
        $post = $request->getParsedBody();
        $schema = new RequestSchema("schema://forms/calendar.json");
        $transformer = new RequestDataTransformer($schema);
        ...
        $calendar4 = new Calendar4($data);
        $calendar4->user_id = $currentUser->id;
		$calendar4->save();
    ...
    public function editForm4($request, $response, $args){
        $ms = $this->ci->alerts;
        $get = $request->getQueryParams();
		$currentUser = $this->ci->currentUser;       
        $calendar4 = Calendar4::where('user_id', $currentUser->id)->first();
		$calendar4_id = $args['calendar4_id'];
        $schema = new RequestSchema("schema://forms/calendar.json");
        $validator = new JqueryValidationAdapter($schema, $this->ci->translator);
        ...
        $this->ci->view->render($response, "FormGeneratorJY/CalxUpdate.html.twig", [
            ...
            "box_title" => "Change",
            "submit_button" => "Change",
            "form_action" => "/calendar/4/".$args['calendar4_id'],
            "form_method" => "PUT", //Send form using PUT instead of "POST"
            "fields" => $form->generate(),
            "validators" => $validator->rules('json', true)
        ]);       
    ...
    public function update4($request, $response, $args){
        $ms = $this->ci->alerts;
		$currentUser = $this->ci->currentUser;
        $calendar4_id = $args['calendar4_id'];
        $calendar4 = Calendar4::where('user_id', $currentUser->id)->first();
    ...
    public function delete4($request, $response, $args){
        $ms = $this->ci->alerts;
		$currentUser = $this->ci->currentUser;
        $calendar4_id = $args['calendar4_id'];
        $calendar4 = Calendar4::where('user_id', $currentUser->id)->first();
    ...
    public function createForm5($request, $response, $args){
        $ms = $this->ci->alerts;
		$currentUser = $this->ci->currentUser;
		$calendar5 = Calendar5::where('user_id', $currentUser->id)->first();
		if ($calendar5 != NULL) {
        ...
        $this->ci->view->render($response, "FormGeneratorJY/CalxUpdate.html.twig", [
            ...
            "box_title" => "Join Game Session",
            "submit_button" => "Join",
            "form_action" => "/calendar/5",
            "fields" => $form->generate(),
            "validators" => $validator->rules('json', true)
        ]);        
    }

    public function create5($request, $response, $args){
        $ms = $this->ci->alerts;
        $post = $request->getParsedBody();
        $schema = new RequestSchema("schema://forms/calendar.json");
        $transformer = new RequestDataTransformer($schema);
        ...
        $calendar5 = new Calendar5($data);
        $calendar5->user_id = $currentUser->id;
		$calendar5->save();
    ...
    public function editForm5($request, $response, $args){
        $ms = $this->ci->alerts;
        $get = $request->getQueryParams();
		$currentUser = $this->ci->currentUser;       
        $calendar5 = Calendar5::where('user_id', $currentUser->id)->first();
		$calendar5_id = $args['calendar5_id'];
        $schema = new RequestSchema("schema://forms/calendar.json");
        $validator = new JqueryValidationAdapter($schema, $this->ci->translator);
      
        $form = new Form($schema, $calendar5);

        $this->ci->view->render($response, "FormGeneratorJY/CalxUpdate.html.twig", [
            "box_id" => $get['box_id'],
            "box_title" => "Change",
            "submit_button" => "Change",
            "form_action" => "/calendar/5/".$args['calendar5_id'],
            "form_method" => "PUT", //Send form using PUT instead of "POST"
            "fields" => $form->generate(),
            "validators" => $validator->rules('json', true)
        ]);       
    ...
    public function update5($request, $response, $args){
        $ms = $this->ci->alerts;
		$currentUser = $this->ci->currentUser;
        $calendar5_id = $args['calendar5_id'];
        $calendar5 = Calendar5::where('user_id', $currentUser->id)->first();
    ...
    public function delete5($request, $response, $args){
        $ms = $this->ci->alerts;
		$currentUser = $this->ci->currentUser;
        $calendar5_id = $args['calendar5_id'];
        $calendar5 = Calendar5::where('user_id', $currentUser->id)->first();
    ...
    public function createForm7($request, $response, $args){
        $ms = $this->ci->alerts;
		$currentUser = $this->ci->currentUser;
		$calendar7 = Calendar7::where('user_id', $currentUser->id)->first();
		if ($calendar7 != NULL) {
        ...
        $this->ci->view->render($response, "FormGeneratorJY/CalxUpdate.html.twig", [
            ...
            "box_title" => "Join Game Session",
            "submit_button" => "Join",
            "form_action" => "/calendar/7",
            "fields" => $form->generate(),
            "validators" => $validator->rules('json', true)
        ]);        
    }

    public function create7($request, $response, $args){
        $ms = $this->ci->alerts;
        $post = $request->getParsedBody();
        $schema = new RequestSchema("schema://forms/calendar.json");
        $transformer = new RequestDataTransformer($schema);
        ...
        $calendar7 = new Calendar7($data);
        $calendar7->user_id = $currentUser->id;
		$calendar7->save();
    ...
    public function editForm7($request, $response, $args){
        $ms = $this->ci->alerts;
        $get = $request->getQueryParams();
		$currentUser = $this->ci->currentUser;       
        $calendar7 = Calendar7::where('user_id', $currentUser->id)->first();
		$calendar7_id = $args['calendar7_id'];
        $schema = new RequestSchema("schema://forms/calendar.json");
        $validator = new JqueryValidationAdapter($schema, $this->ci->translator);
      
        $form = new Form($schema, $calendar7);

        $this->ci->view->render($response, "FormGeneratorJY/CalxUpdate.html.twig", [
            "box_id" => $get['box_id'],
            "box_title" => "Change",
            "submit_button" => "Change",
            "form_action" => "/calendar/7/".$args['calendar7_id'],
            "form_method" => "PUT", //Send form using PUT instead of "POST"
            "fields" => $form->generate(),
            "validators" => $validator->rules('json', true)
        ]);       
    ...
    public function update7($request, $response, $args){
        $ms = $this->ci->alerts;
		$currentUser = $this->ci->currentUser;
        $calendar7_id = $args['calendar7_id'];
        $calendar7 = Calendar7::where('user_id', $currentUser->id)->first();
    ...
    public function delete7($request, $response, $args){
        $ms = $this->ci->alerts;
		$currentUser = $this->ci->currentUser;
        $calendar7_id = $args['calendar7_id'];
        $calendar7 = Calendar7::where('user_id', $currentUser->id)->first();
    ...
    public function createForm8($request, $response, $args){
        $ms = $this->ci->alerts;
		$currentUser = $this->ci->currentUser;
		$calendar8 = Calendar8::where('user_id', $currentUser->id)->first();
		if ($calendar8 != NULL) {
        ...
        $this->ci->view->render($response, "FormGeneratorJY/CalxUpdate.html.twig", [
            ...
            "box_title" => "Join Game Session",
            "submit_button" => "Join",
            "form_action" => "/calendar/8",
            "fields" => $form->generate(),
            "validators" => $validator->rules('json', true)
        ]);        
    }

    public function create8($request, $response, $args){
        $ms = $this->ci->alerts;
        $post = $request->getParsedBody();
        $schema = new RequestSchema("schema://forms/calendar.json");
        $transformer = new RequestDataTransformer($schema);
        ...
        $calendar8 = new Calendar8($data);
        $calendar8->user_id = $currentUser->id;
		$calendar8->save();
    ...
    public function editForm8($request, $response, $args){
        $ms = $this->ci->alerts;
        $get = $request->getQueryParams();
		$currentUser = $this->ci->currentUser;       
        $calendar8 = Calendar8::where('user_id', $currentUser->id)->first();
		$calendar8_id = $args['calendar8_id'];
        $schema = new RequestSchema("schema://forms/calendar.json");
        $validator = new JqueryValidationAdapter($schema, $this->ci->translator);
      
        $form = new Form($schema, $calendar8);

        $this->ci->view->render($response, "FormGeneratorJY/CalxUpdate.html.twig", [
            "box_id" => $get['box_id'],
            "box_title" => "Change",
            "submit_button" => "Change",
            "form_action" => "/calendar/8/".$args['calendar8_id'],
            "form_method" => "PUT", //Send form using PUT instead of "POST"
            "fields" => $form->generate(),
            "validators" => $validator->rules('json', true)
        ]);       
    ...
    public function update8($request, $response, $args){
        $ms = $this->ci->alerts;
		$currentUser = $this->ci->currentUser;
        $calendar8_id = $args['calendar8_id'];
        $calendar8 = Calendar8::where('user_id', $currentUser->id)->first();
    ...
    public function delete8($request, $response, $args){
        $ms = $this->ci->alerts;
		$currentUser = $this->ci->currentUser;
        $calendar8_id = $args['calendar8_id'];
        $calendar8 = Calendar8::where('user_id', $currentUser->id)->first();
    ...
    public function createForm9($request, $response, $args){
        $ms = $this->ci->alerts;
		$currentUser = $this->ci->currentUser;
		$calendar9 = Calendar9::where('user_id', $currentUser->id)->first();
		if ($calendar9 != NULL) {
        ...
        $this->ci->view->render($response, "FormGeneratorJY/CalxUpdate.html.twig", [
            ...
            "box_title" => "Join Game Session",
            "submit_button" => "Join",
            "form_action" => "/calendar/9",
            "fields" => $form->generate(),
            "validators" => $validator->rules('json', true)
        ]);        
    }

    public function create9($request, $response, $args){
        $ms = $this->ci->alerts;
        $post = $request->getParsedBody();
        $schema = new RequestSchema("schema://forms/calendar.json");
        $transformer = new RequestDataTransformer($schema);
        ...
        $calendar9 = new Calendar9($data);
        $calendar9->user_id = $currentUser->id;
		$calendar9->save();
    ...
    public function editForm9($request, $response, $args){
        $ms = $this->ci->alerts;
        $get = $request->getQueryParams();
		$currentUser = $this->ci->currentUser;       
        $calendar9 = Calendar9::where('user_id', $currentUser->id)->first();
		$calendar9_id = $args['calendar9_id'];
        $schema = new RequestSchema("schema://forms/calendar.json");
        $validator = new JqueryValidationAdapter($schema, $this->ci->translator);
      
        $form = new Form($schema, $calendar9);

        $this->ci->view->render($response, "FormGeneratorJY/CalxUpdate.html.twig", [
            "box_id" => $get['box_id'],
            "box_title" => "Change",
            "submit_button" => "Change",
            "form_action" => "/calendar/9/".$args['calendar9_id'],
            "form_method" => "PUT", //Send form using PUT instead of "POST"
            "fields" => $form->generate(),
            "validators" => $validator->rules('json', true)
        ]);       
    ...
    public function update9($request, $response, $args){
        $ms = $this->ci->alerts;
		$currentUser = $this->ci->currentUser;
        $calendar9_id = $args['calendar9_id'];
        $calendar9 = Calendar9::where('user_id', $currentUser->id)->first();
    ...
    public function delete9($request, $response, $args){
        $ms = $this->ci->alerts;
		$currentUser = $this->ci->currentUser;
        $calendar9_id = $args['calendar9_id'];
        $calendar9 = Calendar9::where('user_id', $currentUser->id)->first();
    ...
    public function createForm10($request, $response, $args){
        $ms = $this->ci->alerts;
		$currentUser = $this->ci->currentUser;
		$calendar10 = Calendar10::where('user_id', $currentUser->id)->first();
		if ($calendar10 != NULL) {
        ...
        $this->ci->view->render($response, "FormGeneratorJY/CalxUpdate.html.twig", [
            ...
            "box_title" => "Join Game Session",
            "submit_button" => "Join",
            "form_action" => "/calendar/10",
            "fields" => $form->generate(),
            "validators" => $validator->rules('json', true)
        ]);        
    }

    public function create10($request, $response, $args){
        $ms = $this->ci->alerts;
        $post = $request->getParsedBody();
        $schema = new RequestSchema("schema://forms/calendar.json");
        $transformer = new RequestDataTransformer($schema);
        ...
        $calendar10 = new Calendar10($data);
        $calendar10->user_id = $currentUser->id;
		$calendar10->save();
    ...
    public function editForm10($request, $response, $args){
        $ms = $this->ci->alerts;
        $get = $request->getQueryParams();
		$currentUser = $this->ci->currentUser;       
        $calendar10 = Calendar10::where('user_id', $currentUser->id)->first();
		$calendar10_id = $args['calendar10_id'];
        $schema = new RequestSchema("schema://forms/calendar.json");
        $validator = new JqueryValidationAdapter($schema, $this->ci->translator);
      
        $form = new Form($schema, $calendar10);

        $this->ci->view->render($response, "FormGeneratorJY/CalxUpdate.html.twig", [
            "box_id" => $get['box_id'],
            "box_title" => "Change",
            "submit_button" => "Change",
            "form_action" => "/calendar/10/".$args['calendar10_id'],
            "form_method" => "PUT", //Send form using PUT instead of "POST"
            "fields" => $form->generate(),
            "validators" => $validator->rules('json', true)
        ]);       
    ...
    public function update10($request, $response, $args){
        $ms = $this->ci->alerts;
		$currentUser = $this->ci->currentUser;
        $calendar10_id = $args['calendar10_id'];
        $calendar10 = Calendar10::where('user_id', $currentUser->id)->first();
    ...
    public function delete10($request, $response, $args){
        $ms = $this->ci->alerts;
		$currentUser = $this->ci->currentUser;
        $calendar10_id = $args['calendar10_id'];
        $calendar10 = Calendar10::where('user_id', $currentUser->id)->first();
    ...
    public function createForm11($request, $response, $args){
        $ms = $this->ci->alerts;
		$currentUser = $this->ci->currentUser;
		$calendar11 = Calendar11::where('user_id', $currentUser->id)->first();
		if ($calendar11 != NULL) {
        ...
        $this->ci->view->render($response, "FormGeneratorJY/CalxUpdate.html.twig", [
            ...
            "box_title" => "Join Game Session",
            "submit_button" => "Join",
            "form_action" => "/calendar/11",
            "fields" => $form->generate(),
            "validators" => $validator->rules('json', true)
        ]);        
    }

    public function create11($request, $response, $args){
        $ms = $this->ci->alerts;
        $post = $request->getParsedBody();
        $schema = new RequestSchema("schema://forms/calendar.json");
        $transformer = new RequestDataTransformer($schema);
        ...
        $calendar11 = new Calendar11($data);
        $calendar11->user_id = $currentUser->id;
		$calendar11->save();
    ...
    public function editForm11($request, $response, $args){
        $ms = $this->ci->alerts;
        $get = $request->getQueryParams();
		$currentUser = $this->ci->currentUser;       
        $calendar11 = Calendar11::where('user_id', $currentUser->id)->first();
		$calendar11_id = $args['calendar11_id'];
        $schema = new RequestSchema("schema://forms/calendar.json");
        $validator = new JqueryValidationAdapter($schema, $this->ci->translator);
      
        $form = new Form($schema, $calendar11);

        $this->ci->view->render($response, "FormGeneratorJY/CalxUpdate.html.twig", [
            "box_id" => $get['box_id'],
            "box_title" => "Change",
            "submit_button" => "Change",
            "form_action" => "/calendar/11/".$args['calendar11_id'],
            "form_method" => "PUT", //Send form using PUT instead of "POST"
            "fields" => $form->generate(),
            "validators" => $validator->rules('json', true)
        ]);       
    ...
    public function update11($request, $response, $args){
        $ms = $this->ci->alerts;
		$currentUser = $this->ci->currentUser;
        $calendar11_id = $args['calendar11_id'];
        $calendar11 = Calendar11::where('user_id', $currentUser->id)->first();
    ...
    public function delete11($request, $response, $args){
        $ms = $this->ci->alerts;
		$currentUser = $this->ci->currentUser;
        $calendar11_id = $args['calendar11_id'];
        $calendar11 = Calendar11::where('user_id', $currentUser->id)->first();
    ...
    public function createForm12($request, $response, $args){
        $ms = $this->ci->alerts;
		$currentUser = $this->ci->currentUser;
		$calendar12 = Calendar12::where('user_id', $currentUser->id)->first();
		if ($calendar12 != NULL) {
        ...
        $this->ci->view->render($response, "FormGeneratorJY/CalxUpdate.html.twig", [
            ...
            "box_title" => "Join Game Session",
            "submit_button" => "Join",
            "form_action" => "/calendar/12",
            "fields" => $form->generate(),
            "validators" => $validator->rules('json', true)
        ]);        
    }

    public function create12($request, $response, $args){
        $ms = $this->ci->alerts;
        $post = $request->getParsedBody();
        $schema = new RequestSchema("schema://forms/calendar.json");
        $transformer = new RequestDataTransformer($schema);
        ...
        $calendar12 = new Calendar12($data);
        $calendar12->user_id = $currentUser->id;
		$calendar12->save();
    ...
    public function editForm12($request, $response, $args){
        $ms = $this->ci->alerts;
        $get = $request->getQueryParams();
		$currentUser = $this->ci->currentUser;       
        $calendar12 = Calendar12::where('user_id', $currentUser->id)->first();
		$calendar12_id = $args['calendar12_id'];
        $schema = new RequestSchema("schema://forms/calendar.json");
        $validator = new JqueryValidationAdapter($schema, $this->ci->translator);
      
        $form = new Form($schema, $calendar12);

        $this->ci->view->render($response, "FormGeneratorJY/CalxUpdate.html.twig", [
            "box_id" => $get['box_id'],
            "box_title" => "Change",
            "submit_button" => "Change",
            "form_action" => "/calendar/12/".$args['calendar12_id'],
            "form_method" => "PUT", //Send form using PUT instead of "POST"
            "fields" => $form->generate(),
            "validators" => $validator->rules('json', true)
        ]);       
    ...
    public function update12($request, $response, $args){
        $ms = $this->ci->alerts;
		$currentUser = $this->ci->currentUser;
        $calendar12_id = $args['calendar12_id'];
        $calendar12 = Calendar12::where('user_id', $currentUser->id)->first();
    ...
    public function delete12($request, $response, $args){
        $ms = $this->ci->alerts;
		$currentUser = $this->ci->currentUser;
        $calendar12_id = $args['calendar12_id'];
        $calendar12 = Calendar12::where('user_id', $currentUser->id)->first();
    ...
    public function createForm13($request, $response, $args){
        $ms = $this->ci->alerts;
		$currentUser = $this->ci->currentUser;
		$calendar13 = Calendar13::where('user_id', $currentUser->id)->first();
		if ($calendar13 != NULL) {
        ...
        $this->ci->view->render($response, "FormGeneratorJY/CalxUpdate.html.twig", [
            ...
            "box_title" => "Join Game Session",
            "submit_button" => "Join",
            "form_action" => "/calendar/13",
            "fields" => $form->generate(),
            "validators" => $validator->rules('json', true)
        ]);        
    }

    public function create13($request, $response, $args){
        $ms = $this->ci->alerts;
        $post = $request->getParsedBody();
        $schema = new RequestSchema("schema://forms/calendar.json");
        $transformer = new RequestDataTransformer($schema);
        ...
        $calendar13 = new Calendar13($data);
        $calendar13->user_id = $currentUser->id;
		$calendar13->save();
    ...
    public function editForm13($request, $response, $args){
        $ms = $this->ci->alerts;
        $get = $request->getQueryParams();
		$currentUser = $this->ci->currentUser;       
        $calendar13 = Calendar13::where('user_id', $currentUser->id)->first();
		$calendar13_id = $args['calendar13_id'];
        $schema = new RequestSchema("schema://forms/calendar.json");
        $validator = new JqueryValidationAdapter($schema, $this->ci->translator);
      
        $form = new Form($schema, $calendar13);

        $this->ci->view->render($response, "FormGeneratorJY/CalxUpdate.html.twig", [
            "box_id" => $get['box_id'],
            "box_title" => "Change",
            "submit_button" => "Change",
            "form_action" => "/calendar/13/".$args['calendar13_id'],
            "form_method" => "PUT", //Send form using PUT instead of "POST"
            "fields" => $form->generate(),
            "validators" => $validator->rules('json', true)
        ]);       
    ...
    public function update13($request, $response, $args){
        $ms = $this->ci->alerts;
		$currentUser = $this->ci->currentUser;
        $calendar13_id = $args['calendar13_id'];
        $calendar13 = Calendar13::where('user_id', $currentUser->id)->first();
    ...
    public function delete13($request, $response, $args){
        $ms = $this->ci->alerts;
		$currentUser = $this->ci->currentUser;
        $calendar13_id = $args['calendar13_id'];
        $calendar13 = Calendar13::where('user_id', $currentUser->id)->first();
    ...
    public function createForm14($request, $response, $args){
        $ms = $this->ci->alerts;
		$currentUser = $this->ci->currentUser;
		$calendar14 = Calendar14::where('user_id', $currentUser->id)->first();
		if ($calendar14 != NULL) {
        ...
        $this->ci->view->render($response, "FormGeneratorJY/CalxUpdate.html.twig", [
            ...
            "box_title" => "Join Game Session",
            "submit_button" => "Join",
            "form_action" => "/calendar/14",
            "fields" => $form->generate(),
            "validators" => $validator->rules('json', true)
        ]);        
    }

    public function create14($request, $response, $args){
        $ms = $this->ci->alerts;
        $post = $request->getParsedBody();
        $schema = new RequestSchema("schema://forms/calendar.json");
        $transformer = new RequestDataTransformer($schema);
        ...
        $calendar14 = new Calendar14($data);
        $calendar14->user_id = $currentUser->id;
		$calendar14->save();
    ...
    public function editForm14($request, $response, $args){
        $ms = $this->ci->alerts;
        $get = $request->getQueryParams();
		$currentUser = $this->ci->currentUser;       
        $calendar14 = Calendar14::where('user_id', $currentUser->id)->first();
		$calendar14_id = $args['calendar14_id'];
        $schema = new RequestSchema("schema://forms/calendar.json");
        $validator = new JqueryValidationAdapter($schema, $this->ci->translator);
      
        $form = new Form($schema, $calendar14);

        $this->ci->view->render($response, "FormGeneratorJY/CalxUpdate.html.twig", [
            "box_id" => $get['box_id'],
            "box_title" => "Change",
            "submit_button" => "Change",
            "form_action" => "/calendar/14/".$args['calendar14_id'],
            "form_method" => "PUT", //Send form using PUT instead of "POST"
            "fields" => $form->generate(),
            "validators" => $validator->rules('json', true)
        ]);       
    ...
    public function update14($request, $response, $args){
        $ms = $this->ci->alerts;
		$currentUser = $this->ci->currentUser;
        $calendar14_id = $args['calendar14_id'];
        $calendar14 = Calendar14::where('user_id', $currentUser->id)->first();
    ...
    public function delete14($request, $response, $args){
        $ms = $this->ci->alerts;
		$currentUser = $this->ci->currentUser;
        $calendar14_id = $args['calendar14_id'];
        $calendar14 = Calendar14::where('user_id', $currentUser->id)->first();
    ...
    public function createForm15($request, $response, $args){
        $ms = $this->ci->alerts;
		$currentUser = $this->ci->currentUser;
		$calendar15 = Calendar15::where('user_id', $currentUser->id)->first();
		if ($calendar15 != NULL) {
        ...
        $this->ci->view->render($response, "FormGeneratorJY/CalxUpdate.html.twig", [
            ...
            "box_title" => "Join Game Session",
            "submit_button" => "Join",
            "form_action" => "/calendar/15",
            "fields" => $form->generate(),
            "validators" => $validator->rules('json', true)
        ]);        
    }

    public function create15($request, $response, $args){
        $ms = $this->ci->alerts;
        $post = $request->getParsedBody();
        $schema = new RequestSchema("schema://forms/calendar.json");
        $transformer = new RequestDataTransformer($schema);
        ...
        $calendar15 = new Calendar15($data);
        $calendar15->user_id = $currentUser->id;
		$calendar15->save();
    ...
    public function editForm15($request, $response, $args){
        $ms = $this->ci->alerts;
        $get = $request->getQueryParams();
		$currentUser = $this->ci->currentUser;       
        $calendar15 = Calendar15::where('user_id', $currentUser->id)->first();
		$calendar15_id = $args['calendar15_id'];
        $schema = new RequestSchema("schema://forms/calendar.json");
        $validator = new JqueryValidationAdapter($schema, $this->ci->translator);
      
        $form = new Form($schema, $calendar15);

        $this->ci->view->render($response, "FormGeneratorJY/CalxUpdate.html.twig", [
            "box_id" => $get['box_id'],
            "box_title" => "Change",
            "submit_button" => "Change",
            "form_action" => "/calendar/15/".$args['calendar15_id'],
            "form_method" => "PUT", //Send form using PUT instead of "POST"
            "fields" => $form->generate(),
            "validators" => $validator->rules('json', true)
        ]);       
    ...
    public function update15($request, $response, $args){
        $ms = $this->ci->alerts;
		$currentUser = $this->ci->currentUser;
        $calendar15_id = $args['calendar15_id'];
        $calendar15 = Calendar15::where('user_id', $currentUser->id)->first();
    ...
    public function delete15($request, $response, $args){
        $ms = $this->ci->alerts;
		$currentUser = $this->ci->currentUser;
        $calendar15_id = $args['calendar15_id'];
        $calendar15 = Calendar15::where('user_id', $currentUser->id)->first();
    ...
    public function createForm16($request, $response, $args){
        $ms = $this->ci->alerts;
		$currentUser = $this->ci->currentUser;
		$calendar16 = Calendar16::where('user_id', $currentUser->id)->first();
		if ($calendar16 != NULL) {
        ...
        $this->ci->view->render($response, "FormGeneratorJY/CalxUpdate.html.twig", [
            ...
            "box_title" => "Join Game Session",
            "submit_button" => "Join",
            "form_action" => "/calendar/16",
            "fields" => $form->generate(),
            "validators" => $validator->rules('json', true)
        ]);        
    }

    public function create16($request, $response, $args){
        $ms = $this->ci->alerts;
        $post = $request->getParsedBody();
        $schema = new RequestSchema("schema://forms/calendar.json");
        $transformer = new RequestDataTransformer($schema);
        ...
        $calendar16 = new Calendar16($data);
        $calendar16->user_id = $currentUser->id;
		$calendar16->save();
    ...
    public function editForm16($request, $response, $args){
        $ms = $this->ci->alerts;
        $get = $request->getQueryParams();
		$currentUser = $this->ci->currentUser;       
        $calendar16 = Calendar16::where('user_id', $currentUser->id)->first();
		$calendar16_id = $args['calendar16_id'];
        $schema = new RequestSchema("schema://forms/calendar.json");
        $validator = new JqueryValidationAdapter($schema, $this->ci->translator);
      
        $form = new Form($schema, $calendar16);

        $this->ci->view->render($response, "FormGeneratorJY/CalxUpdate.html.twig", [
            "box_id" => $get['box_id'],
            "box_title" => "Change",
            "submit_button" => "Change",
            "form_action" => "/calendar/16/".$args['calendar16_id'],
            "form_method" => "PUT", //Send form using PUT instead of "POST"
            "fields" => $form->generate(),
            "validators" => $validator->rules('json', true)
        ]);       
    ...
    public function update16($request, $response, $args){
        $ms = $this->ci->alerts;
		$currentUser = $this->ci->currentUser;
        $calendar16_id = $args['calendar16_id'];
        $calendar16 = Calendar16::where('user_id', $currentUser->id)->first();
    ...
    public function delete16($request, $response, $args){
        $ms = $this->ci->alerts;
		$currentUser = $this->ci->currentUser;
        $calendar16_id = $args['calendar16_id'];
        $calendar16 = Calendar16::where('user_id', $currentUser->id)->first();
    ...
    public function createForm17($request, $response, $args){
        $ms = $this->ci->alerts;
		$currentUser = $this->ci->currentUser;
		$calendar17 = Calendar17::where('user_id', $currentUser->id)->first();
		if ($calendar17 != NULL) {
        ...
        $this->ci->view->render($response, "FormGeneratorJY/CalxUpdate.html.twig", [
            ...
            "box_title" => "Join Game Session",
            "submit_button" => "Join",
            "form_action" => "/calendar/17",
            "fields" => $form->generate(),
            "validators" => $validator->rules('json', true)
        ]);        
    }

    public function create17($request, $response, $args){
        $ms = $this->ci->alerts;
        $post = $request->getParsedBody();
        $schema = new RequestSchema("schema://forms/calendar.json");
        $transformer = new RequestDataTransformer($schema);
        ...
        $calendar17 = new Calendar17($data);
        $calendar17->user_id = $currentUser->id;
		$calendar17->save();
    ...
    public function editForm17($request, $response, $args){
        $ms = $this->ci->alerts;
        $get = $request->getQueryParams();
		$currentUser = $this->ci->currentUser;       
        $calendar17 = Calendar17::where('user_id', $currentUser->id)->first();
		$calendar17_id = $args['calendar17_id'];
        $schema = new RequestSchema("schema://forms/calendar.json");
        $validator = new JqueryValidationAdapter($schema, $this->ci->translator);
      
        $form = new Form($schema, $calendar17);

        $this->ci->view->render($response, "FormGeneratorJY/CalxUpdate.html.twig", [
            "box_id" => $get['box_id'],
            "box_title" => "Change",
            "submit_button" => "Change",
            "form_action" => "/calendar/17/".$args['calendar17_id'],
            "form_method" => "PUT", //Send form using PUT instead of "POST"
            "fields" => $form->generate(),
            "validators" => $validator->rules('json', true)
        ]);       
    ...
    public function update17($request, $response, $args){
        $ms = $this->ci->alerts;
		$currentUser = $this->ci->currentUser;
        $calendar17_id = $args['calendar17_id'];
        $calendar17 = Calendar17::where('user_id', $currentUser->id)->first();
    ...
    public function delete17($request, $response, $args){
        $ms = $this->ci->alerts;
		$currentUser = $this->ci->currentUser;
        $calendar17_id = $args['calendar17_id'];
        $calendar17 = Calendar17::where('user_id', $currentUser->id)->first();
    ...
    public function createForm18($request, $response, $args){
        $ms = $this->ci->alerts;
		$currentUser = $this->ci->currentUser;
		$calendar18 = Calendar18::where('user_id', $currentUser->id)->first();
		if ($calendar18 != NULL) {
        ...
        $this->ci->view->render($response, "FormGeneratorJY/CalxUpdate.html.twig", [
            ...
            "box_title" => "Join Game Session",
            "submit_button" => "Join",
            "form_action" => "/calendar/18",
            "fields" => $form->generate(),
            "validators" => $validator->rules('json', true)
        ]);        
    }

    public function create18($request, $response, $args){
        $ms = $this->ci->alerts;
        $post = $request->getParsedBody();
        $schema = new RequestSchema("schema://forms/calendar.json");
        $transformer = new RequestDataTransformer($schema);
        ...
        $calendar18 = new Calendar18($data);
        $calendar18->user_id = $currentUser->id;
		$calendar18->save();
    ...
    public function editForm18($request, $response, $args){
        $ms = $this->ci->alerts;
        $get = $request->getQueryParams();
		$currentUser = $this->ci->currentUser;       
        $calendar18 = Calendar18::where('user_id', $currentUser->id)->first();
		$calendar18_id = $args['calendar18_id'];
        $schema = new RequestSchema("schema://forms/calendar.json");
        $validator = new JqueryValidationAdapter($schema, $this->ci->translator);
        ...
        $this->ci->view->render($response, "FormGeneratorJY/CalxUpdate.html.twig", [
            ...
            "box_title" => "Change",
            "submit_button" => "Change",
            "form_action" => "/calendar/18/".$args['calendar18_id'],
            "form_method" => "PUT", //Send form using PUT instead of "POST"
            "fields" => $form->generate(),
            "validators" => $validator->rules('json', true)
        ]);       
    ...
    public function update18($request, $response, $args){
        $ms = $this->ci->alerts;
		$currentUser = $this->ci->currentUser;
        $calendar18_id = $args['calendar18_id'];
        $calendar18 = Calendar18::where('user_id', $currentUser->id)->first();
    ...
    public function delete18($request, $response, $args){
        $ms = $this->ci->alerts;
		$currentUser = $this->ci->currentUser;
        $calendar18_id = $args['calendar18_id'];
        $calendar18 = Calendar18::where('user_id', $currentUser->id)->first();
    ...
    public function createForm19($request, $response, $args){
        $ms = $this->ci->alerts;
		$currentUser = $this->ci->currentUser;
		$calendar19 = Calendar19::where('user_id', $currentUser->id)->first();
		if ($calendar19 != NULL) {
        ...
        $this->ci->view->render($response, "FormGeneratorJY/CalxUpdate.html.twig", [
            ...
            "box_title" => "Join Game Session",
            "submit_button" => "Join",
            "form_action" => "/calendar/19",
            "fields" => $form->generate(),
            "validators" => $validator->rules('json', true)
        ]);        
    }

    public function create19($request, $response, $args){
        $ms = $this->ci->alerts;
        $post = $request->getParsedBody();
        $schema = new RequestSchema("schema://forms/calendar.json");
        $transformer = new RequestDataTransformer($schema);
        ...
        $calendar19 = new Calendar19($data);
        $calendar19->user_id = $currentUser->id;
		$calendar19->save();
    ...
    public function editForm19($request, $response, $args){
        $ms = $this->ci->alerts;
        $get = $request->getQueryParams();
		$currentUser = $this->ci->currentUser;       
        $calendar19 = Calendar19::where('user_id', $currentUser->id)->first();
		$calendar19_id = $args['calendar19_id'];
        $schema = new RequestSchema("schema://forms/calendar.json");
        $validator = new JqueryValidationAdapter($schema, $this->ci->translator);
      
        $form = new Form($schema, $calendar19);

        $this->ci->view->render($response, "FormGeneratorJY/CalxUpdate.html.twig", [
            "box_id" => $get['box_id'],
            "box_title" => "Change",
            "submit_button" => "Change",
            "form_action" => "/calendar/19/".$args['calendar19_id'],
            "form_method" => "PUT", //Send form using PUT instead of "POST"
            "fields" => $form->generate(),
            "validators" => $validator->rules('json', true)
        ]);       
    ...
    public function update19($request, $response, $args){
        $ms = $this->ci->alerts;
		$currentUser = $this->ci->currentUser;
        $calendar19_id = $args['calendar19_id'];
        $calendar19 = Calendar19::where('user_id', $currentUser->id)->first();
    ...
    public function delete19($request, $response, $args){
        $ms = $this->ci->alerts;
		$currentUser = $this->ci->currentUser;
        $calendar19_id = $args['calendar19_id'];
        $calendar19 = Calendar19::where('user_id', $currentUser->id)->first();
    ...
    public function createForm20($request, $response, $args){
        $ms = $this->ci->alerts;
		$currentUser = $this->ci->currentUser;
		$calendar20 = Calendar20::where('user_id', $currentUser->id)->first();
		if ($calendar20 != NULL) {
        ...
        $this->ci->view->render($response, "FormGeneratorJY/CalxUpdate.html.twig", [
            ...
            "box_title" => "Join Game Session",
            "submit_button" => "Join",
            "form_action" => "/calendar/20",
            "fields" => $form->generate(),
            "validators" => $validator->rules('json', true)
        ]);        
    }

    public function create20($request, $response, $args){
        $ms = $this->ci->alerts;
        $post = $request->getParsedBody();
        $schema = new RequestSchema("schema://forms/calendar.json");
        $transformer = new RequestDataTransformer($schema);
        ...
        $calendar20 = new Calendar20($data);
        $calendar20->user_id = $currentUser->id;
		$calendar20->save();
    ...
    public function editForm20($request, $response, $args){
        $ms = $this->ci->alerts;
        $get = $request->getQueryParams();
		$currentUser = $this->ci->currentUser;       
        $calendar20 = Calendar20::where('user_id', $currentUser->id)->first();
		$calendar20_id = $args['calendar20_id'];
        $schema = new RequestSchema("schema://forms/calendar.json");
        $validator = new JqueryValidationAdapter($schema, $this->ci->translator);
      
        $form = new Form($schema, $calendar20);

        $this->ci->view->render($response, "FormGeneratorJY/CalxUpdate.html.twig", [
            "box_id" => $get['box_id'],
            "box_title" => "Change",
            "submit_button" => "Change",
            "form_action" => "/calendar/20/".$args['calendar20_id'],
            "form_method" => "PUT", //Send form using PUT instead of "POST"
            "fields" => $form->generate(),
            "validators" => $validator->rules('json', true)
        ]);       
    ...
    public function update20($request, $response, $args){
        $ms = $this->ci->alerts;
		$currentUser = $this->ci->currentUser;
        $calendar20_id = $args['calendar20_id'];
        $calendar20 = Calendar20::where('user_id', $currentUser->id)->first();
    ...
    public function delete20($request, $response, $args){
        $ms = $this->ci->alerts;
		$currentUser = $this->ci->currentUser;
        $calendar20_id = $args['calendar20_id'];
        $calendar20 = Calendar20::where('user_id', $currentUser->id)->first();
